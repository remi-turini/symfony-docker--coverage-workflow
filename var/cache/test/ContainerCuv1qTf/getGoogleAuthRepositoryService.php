 ...
 */
class getGoogleAuthRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GoogleAuthRepository.php';

        return $container->privates['App\\Repository\\GoogleAuthRepository'] = new \App\Repository\GoogleAuthRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
