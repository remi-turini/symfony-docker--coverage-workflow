 ...
 */
class getPharmappConfigurationRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PharmappConfigurationRepository.php';

        return $container->privates['App\\Repository\\PharmappConfigurationRepository'] = new \App\Repository\PharmappConfigurationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
