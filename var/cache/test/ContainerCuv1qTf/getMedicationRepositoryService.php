 ...
 */
class getMedicationRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MedicationRepository.php';

        return $container->privates['App\\Repository\\MedicationRepository'] = new \App\Repository\MedicationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
