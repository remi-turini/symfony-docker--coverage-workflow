 ...
 */
class getTypeMedicationRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeMedicationRepository.php';

        return $container->privates['App\\Repository\\TypeMedicationRepository'] = new \App\Repository\TypeMedicationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
