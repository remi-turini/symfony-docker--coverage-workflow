 ...
 */
class getMedicationInTakeRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MedicationInTakeRepository.php';

        return $container->privates['App\\Repository\\MedicationInTakeRepository'] = new \App\Repository\MedicationInTakeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
